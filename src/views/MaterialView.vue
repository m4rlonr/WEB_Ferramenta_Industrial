                  ...
                  <v-form v-model="valid_form" ref="ref_form">
                    <v-row>
                      ...
                      <v-col cols="12" xs="12" sm="3" md="3" lg="3" xl="3">
                        <v-text-field type="number" required :rules="rules.existencia" v-model="Objeto.quantidade"
                          label="Quantidade">
                        </v-text-field>
                      </v-col>
                      <v-col cols="12" xs="12" sm="3" md="3" lg="3" xl="3">
                        <v-select v-model="Objeto.medida" :items="choices" label="Unidade de medida"></v-select>
                      </v-col>
                    </v-row>
                  </v-form>
                </v-col>
